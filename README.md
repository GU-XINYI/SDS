...
- **Reproducing**:  capability to re-implement parts of methods and algorithms and/or portions of tests and experimental validations, using the **R programming language**.
